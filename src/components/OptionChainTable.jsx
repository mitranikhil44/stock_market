  ...
  return (
    <div className="w-full overflow-x-auto rounded-2xl border border-white/10 bg-white/5 backdrop-blur p-3">
      <div className="max-h-screen overflow-y-auto">
        ...
        <table className="min-w-[900px] w-full table-auto text-xs sm:text-sm overflow-scroll">
          <thead className="sticky top-0 z-10 bg-black">
            <tr className="text-gray-300 border-b border-white/10">
              ...
              <th className="py-1 px-1 text-right">Call Chg LTP</th>

              <th className="py-1 px-1 text-right">Put LTP</th>
              <th className="py-1 px-1 text-right">Put Chg LTP</th>
              <th className="py-1 px-1 text-right">Put Vol</th>
              <th className="py-1 px-1 text-right">Put OI</th>
            </tr>
          </thead>
          <tbody>
        ...
        <p className="mt-2 text-[11px] text-gray-400">
          ...
          strike.{" "}
          {showPrevInline
            ? "Previous snapshot values are shown under the current number."
            : "Hover to see previous values."}
        </p>
      </div>
    </div>
  );
